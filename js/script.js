...
function buildCarousel(type, projects = []) {
  ...
  // ensure container has some height so arrows can center before images load
  container.style.minHeight = '320px';

  // Find the "next" arrow so slides can be inserted before it
  ...
  projects.forEach((project, i) => {
    ...
    // When the image loads, set container minHeight if needed
